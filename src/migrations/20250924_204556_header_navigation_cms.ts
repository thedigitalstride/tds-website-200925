...
export async function up({ db, payload: _payload, req: _req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "header" ADD COLUMN "cta_button_link_label" varchar;
  ...
  UPDATE "header" SET "cta_button_link_label" = 'ENQUIRE' WHERE "cta_button_link_label" IS NULL;
  ALTER TABLE "header" ALTER COLUMN "cta_button_link_label" SET NOT NULL;
...
export async function down({ db, payload: _payload, req: _req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "header" ALTER COLUMN "cta_button_link_label" DROP NOT NULL;
