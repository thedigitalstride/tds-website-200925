...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TYPE "public"."enum_pages_blocks_hero_heading_hero_layout" ADD VALUE 'standardContained';
  ALTER TYPE "public"."enum__pages_v_blocks_hero_heading_hero_layout" ADD VALUE 'standardContained';
  ...
  ALTER TABLE "pages_blocks_hero_heading" ADD COLUMN "hero_background" "enum_pages_blocks_hero_heading_hero_background" DEFAULT 'primary';
  ALTER TABLE "_pages_v_blocks_hero_heading" ADD COLUMN "hero_background" "enum__pages_v_blocks_hero_heading_hero_background" DEFAULT 'primary';
