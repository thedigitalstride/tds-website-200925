...
export async function down({ db, payload: _payload, req: _req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "pages" ADD COLUMN "cta_button_link_uui_color" "enum_pages_cta_button_link_uui_color" DEFAULT 'accent';
  ...
  ALTER TABLE "_pages_v" ADD COLUMN "version_cta_button_link_uui_color" "enum__pages_v_version_cta_button_link_uui_color" DEFAULT 'accent';
