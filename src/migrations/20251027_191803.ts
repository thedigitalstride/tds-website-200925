...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  // Create the background section content blocks table
  await db.execute(sql`
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_background_section" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"header_content_h_p" varchar,
  	"header_heading" varchar,
  	"header_subheading" varchar,
  	"header_h_e_a_d_e_r_alignment" "public"."enum_pages_blocks_background_section_header_header_alignment" DEFAULT 'left',
  	...
  	"s_o_l_i_d_color" "public"."enum_pages_blocks_background_section_solid_color" DEFAULT 'primary',
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_background_section" (
  	...
  	"header_heading" varchar,
  	"header_subheading" varchar,
  	"header_h_e_a_d_e_r_alignment" "public"."enum__pages_v_blocks_background_section_header_header_alignment" DEFAULT 'left',
  	...
  	"s_o_l_i_d_color" "public"."enum__pages_v_blocks_background_section_solid_color" DEFAULT 'primary',
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_background_section" ADD CONSTRAINT "pages_blocks_background_section_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_background_section" ADD CONSTRAINT "_pages_v_blocks_background_section_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   DROP TABLE "pages_blocks_background_section_content_blocks" CASCADE;
  DROP TABLE "_pages_v_blocks_background_section_content_blocks" CASCADE;
  DROP TABLE "pages_blocks_background_section" CASCADE;
  DROP TABLE "_pages_v_blocks_background_section" CASCADE;
  DROP TYPE "public"."enum_pages_blocks_background_section_header_header_alignment" CASCADE;
  DROP TYPE "public"."enum_pages_blocks_background_section_header_text_color" CASCADE;
  DROP TYPE "public"."enum_pages_blocks_background_section_background_type" CASCADE;
  DROP TYPE "public"."enum_pages_blocks_background_section_solid_color" CASCADE;
  DROP TYPE "public"."enum_pages_blocks_background_section_gradient" CASCADE;
  DROP TYPE "public"."enum_pages_blocks_background_section_image_overlay" CASCADE;
  DROP TYPE "public"."enum_pages_blocks_background_section_image_position" CASCADE;
  DROP TYPE "public"."enum_pages_blocks_background_section_spacing" CASCADE;
  DROP TYPE "public"."enum_pages_blocks_background_section_content_width" CASCADE;
  DROP TYPE "public"."enum_pages_blocks_background_section_color_mode" CASCADE;
  DROP TYPE "public"."enum__pages_v_blocks_background_section_header_header_alignment" CASCADE;
  DROP TYPE "public"."enum__pages_v_blocks_background_section_header_text_color" CASCADE;
  DROP TYPE "public"."enum__pages_v_blocks_background_section_background_type" CASCADE;
  DROP TYPE "public"."enum__pages_v_blocks_background_section_solid_color" CASCADE;
  DROP TYPE "public"."enum__pages_v_blocks_background_section_gradient" CASCADE;
  DROP TYPE "public"."enum__pages_v_blocks_background_section_image_overlay" CASCADE;
  DROP TYPE "public"."enum__pages_v_blocks_background_section_image_position" CASCADE;
  DROP TYPE "public"."enum__pages_v_blocks_background_section_spacing" CASCADE;
  DROP TYPE "public"."enum__pages_v_blocks_background_section_content_width" CASCADE;
  DROP TYPE "public"."enum__pages_v_blocks_background_section_color_mode" CASCADE;`);
}