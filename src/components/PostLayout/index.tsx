    ...
    <div>
      ...
      <div className="relative mx-auto grid max-w-container grid-cols-1 items-center gap-16 px-4 pb-16 md:grid-cols-2 md:gap-8 md:px-8 md:pt-16 md:pb-24">
        ...
        <div className="flex max-w-180 flex-col items-start">
          ...
          <h1 className="text-display-md font-semibold text-primary md:text-display-lg">{title}</h1>

          {/* Subtitle/Lead */}
          {subtitle && (
            <p className="mt-4 text-lg text-tertiary md:mt-6 md:max-w-120 md:text-xl">{subtitle}</p>
          )}
        </div>
                  ...
                  .map((category, index) => {
                    ...
                    if (
                      ...
                      return (
                        ...
                        >
                          <Badge size="sm" className="hover:bg-secondary transition-colors">
                            {category.title}
                          </Badge>
                        </a>
                      )
