...
import type { InputBaseProps } from "@/components/uui/base/input/input";
...
export const PaymentInput = ({ onChange, value, defaultValue, className, maxLength = 19, label, hint, ...props }: Omit<InputBaseProps, "icon">) => {
