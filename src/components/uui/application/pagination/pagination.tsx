  ...
  return (
    <Pagination.Item
      ...
      className={({ isSelected }) =>
        cx(
          'flex size-10 cursor-pointer items-center justify-center p-3 text-sm font-medium text-gray-900! dark:text-white! outline-focus-ring transition duration-100 ease-linear hover:bg-gray-300 dark:hover:bg-brand-700 hover:text-gray-900! dark:hover:text-white! focus-visible:z-10 focus-visible:bg-gray-300 dark:focus-visible:bg-brand-700 focus-visible:outline-2 focus-visible:outline-offset-2',
...
export const PaginationPageDefault = ({
  ...
  return (
    <Pagination.Root
      ...
      total={total}
      className={cx(
        'flex w-full items-center justify-between gap-3 border-t-2 border-white pt-4 md:pt-5',
        className,
      )}
    >
...
export const PaginationCardDefault = ({
  ...
  return (
    <Pagination.Root
      ...
      page={page}
      total={total}
      className="flex w-full items-center justify-between gap-3 border-t-2 border-white px-4 py-3 md:px-6 md:pt-3 md:pb-4"
    >
      <div className="flex flex-1 justify-start">
        <Pagination.PrevTrigger asChild>
          <Button iconLeading={ArrowLeft} color="secondary" size="sm">
...
export const PaginationCardMinimal = ({
  ...
  return (
    <div className={cx('border-t-2 border-white px-4 py-3 md:px-6 md:pt-3 md:pb-4', className)}>
...
export const PaginationButtonGroup = ({
  ...
  return (
    <div
      className={cx(
        'flex border-t-2 border-white px-4 py-3 md:px-6 md:pt-3 md:pb-4',
