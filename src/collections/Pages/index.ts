...
import { BackgroundSection } from '../../blocks/BackgroundSection/config'
      ...
      tabs: [
        {
          ...
          fields: [
            ...
            },
            {
              name: 'layout',
              type: 'blocks',
              blocks: [HeroHeadingBlock, BackgroundSection, BreadcrumbBlock, CallToAction, Content, MediaBlock, Archive, FormBlock, CardGridBlock, FeaturesBlock, LatestPostsBlock, AccordionBlock],
              admin: {
                initCollapsed: true,
              },
            },
        ...
        },
        {
          ...
          fields: [
            ...
            }),
            {
              ...
              admin: {
                initCollapsed: true,
                description: 'Configure how this page appears in the sitemap',
              },
              fields: [
                {
                  ...
                  defaultValue: false,
                  admin: {
                    description: 'Check this to exclude this page from the sitemap',
                  },
                },
                {
                  ...
                  max: 1,
                  admin: {
                    description: 'Priority of this page relative to other pages (0.0 to 1.0). Leave empty for automatic priority.',
                    step: 0.1,
                  },
                },
                {
                  ...
                  admin: {
                    description: 'How frequently the page is likely to change. Leave empty for automatic frequency.',
                  },
                },
              ],
            },
