...
**Description**: Environment variables for the MongoDB migration script (`scripts/migrate-mongodb-to-local.js`)
...
**Security**: Never commit `MONGODB_ATLAS_URI` to version control. Always store in `.env` file.
